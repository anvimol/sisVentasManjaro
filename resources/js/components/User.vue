            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="email-input">Número Doc.</label>
                            <div class="col-md-9">
                                <input type="text" v-model="num_documento" class="form-control" placeholder="Ingrese Nº de documento">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona() {
                ...
                if (!this.password) this.errorMostrarMsjPersona.push("La contraseña no puede estar vacia.");
                if (this.role_id == 0) this.errorMostrarMsjPersona.push("Debe seleccionar un rol para el usuario.");
