...
class VentaController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($buscar=='') {
            $ventas = Venta::join('personas','ventas.cliente_id','=','personas.id')
    ...
    public function obtenerCabecera(Request $request) {
        ...
        $venta = Venta::join('personas','ventas.cliente_id','=','personas.id')
        ->join('users','ventas.usuario_id','=','users.id')
        ->select('ventas.id','ventas.tipo_comprobante','ventas.serie_comprobante',
        'ventas.num_comprobante','ventas.fecha_hora','ventas.impuesto','ventas.total',
        'ventas.estado','personas.nombre','users.usuario')
    ...
    public function obtenerDetalles(Request $request) {
        ...
        $detalles = DetalleVenta::join('articulos','detalle_ventas.articulo_id','=','articulos.id')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $venta->usuario_id = \Auth::user()->id; // Usuario autenticado
